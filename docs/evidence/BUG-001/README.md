...
Usuário não autenticado tenta adicionar **11 unidades** de um produto cujo estoque disponível é de **10 unidades**.

### Resultado observado

- A mensagem de limite de estoque é exibida corretamente.
- Apenas **10 unidades** são adicionadas ao carrinho.
...
Após retornar à página inicial e acessar novamente o mesmo produto, o usuário tenta novamente adicionar uma quantidade superior ao estoque disponível.

### Resultado observado

- O carrinho continua limitado a **10 unidades**.
